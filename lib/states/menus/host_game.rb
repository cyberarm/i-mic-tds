  ...
  class States
    class HostGame < Menu
      def menu_setup
        ...
        stack(width: 1.0, max_width: 900, fill: true, padding: 4, h_align: :center, scroll: true, border_thickness: 2,
          ...
          flow(width: 1.0, height: 40, margin_top: 4) do
            ...
            list_box items: ["Team Deathmatch", "Capture the Flag", "Bomb Detonation", "King of the Hill", "All Modes"],
                     choose: "All Modes", fill: true
          end
          ...
          flow(width: 1.0, height: 40, margin_top: 4) do
            ...
            list_box items: %w[Hosted LAN Internet], choose: "Hosted", fill: true
          end

          tagline "Bots", margin_top: 16
          flow(width: 1.0, height: 36, margin_top: 4, margin_left: 32, padding: 4, border_thickness: 2,
               border_color: 0xaa_252525) do
            ...
            flow(width: 128, height: 32, margin_top: 4, margin_left: 16) do
              toggle_button checked: true, height: 1.0,
                            tip: "All human players are on one team and only bots on the other"
          ...
          flow(width: 1.0, height: 32, margin_top: 4, margin_left: 32, padding: 4, border_thickness: 2,
               border_color: 0xaa_252525) do
            toggle_button checked: true, height: 1.0
          ...
          flow(width: 1.0, fill: true, min_height: 128, margin_left: 32, padding: 4, border_thickness: 2,
               border_color: 0xaa_252525, scroll: true) do
            %w[Grassland Forest Metro].each_with_index do |map, i|
